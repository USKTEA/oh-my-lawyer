...
class InterpretationParser : LawApiParser {
    override fun parseTotalCount(searchResult: JsonNode): Int = searchResult.path("Expc").path("totalCnt").asInt(0)
    ...
    override fun parseItemId(item: JsonNode): String? = item.textOrNull("법령해석례일련번호")
