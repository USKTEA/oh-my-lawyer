...
class AdministrativeRuleParser : LawApiParser {
    override fun parseTotalCount(searchResult: JsonNode): Int = searchResult.path("AdmRulSearch").path("totalCnt").asInt(0)
    ...
    override fun parseItemId(item: JsonNode): String? = item.textOrNull("행정규칙일련번호")
